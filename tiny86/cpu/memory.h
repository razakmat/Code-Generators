...
namespace tiny::t86::Memory {
    class Immediate {
    public:
        Immediate(uint64_t index) : index_(index) {}
    ...
    class Register {
    public:
        Register(t86::Register reg) : register_(reg) {}
    ...
    public:
        RegisterOffset(t86::RegisterOffset regOffset) : regOffset_(regOffset) {}
    ...
    public:
        RegisterScaled(t86::RegisterScaled regScaled) : regScaled_(regScaled) {}
    ...
    public:
        RegisterRegister(t86::RegisterRegister regReg) : regReg_(regReg) {}
    ...
    public:
        RegisterOffsetRegister(t86::RegisterOffsetRegister regOffReg) : regOffsetReg_(regOffReg) {}
    ...
    public:
        RegisterRegisterScaled(t86::RegisterRegisterScaled regRegScaled) : regRegScaled_(regRegScaled) {}
    ...
    public:
        RegisterOffsetRegisterScaled(t86::RegisterOffsetRegisterScaled regOffRegScaled) : regOffsetRegScaled_(regOffRegScaled) {}
